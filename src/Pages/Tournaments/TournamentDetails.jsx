  ...
  return (
    <div className="flex flex-col p-6 gap-2 md:gap-8">
      ...
      <div className="w-80 p-6 border-l border-[#e9eaef]">
        ...
        <div className="mb-6">
          <h3 className="font-semibold text-[#1e2d5e] mb-3">Event Details</h3>
          <p className="text-[#9a9ca2]"><strong>Location:</strong> {event.location || "Not specified"}</p>
          <p className="text-[#9a9ca2]"><strong>Price:</strong> {event.price || "Not specified"}</p>
          <p className="text-[#9a9ca2]"><strong>Register By:</strong> {event.registerBy || "Not specified"}</p>
        </div>
      </div>
    </div>
  );
