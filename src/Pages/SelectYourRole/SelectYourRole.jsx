...
const SelectYourRole = () => {
  ...
  const handleContinue = () => {
    if (selectedRole) {
      ...
      navigate("/signup", {
        state: { selectedRole: role.id, badge: role.badge },
      });
    } else {
      ...
      <div className="flex flex-col w-full max-w-[800px] items-center gap-6 ">
        ...
        >
          {roles.map((role, index) => (
            <div
              className={`w-full mb-0  ${index === 1 ? "md:mt-9" : "mt-0"} ${
        ...
        <div className="w-full flex justify-center md:justify-end">
          <Button
            ...
            className="w-48 bg-button-bg text-button-text rounded-lg py-6 font-base-medium"
          >
            Continue
          </Button>
        </div>
