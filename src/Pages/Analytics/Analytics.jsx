        ...
        <div className="flex flex-col md:flex-row  justify-center md:justify-between  items-center md:items-start ">
          <div className="text-center md:text-left mb-4 md:mb-0">
            ...
            <p className="text-secondary text-sm md:text-base">
              Track your bowling performance, content engagement, and platform
              activity.
            </p>
          </div>
      ...
      <div className="p-6 space-y-4 md:space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-6">
          {AchievementsData.map((achievement, index) => (
            <Card
              key={index}
              className="border-gray-200 bg-transparent  cursor-pointer hover:shadow-lg transition-shadow duration-200"
            >
              <CardContent className="px-6 py-0">
                ...
                <div className="space-y-1">
                  <p className="text-xl md:text-2xl mb-2 font-semibold md:font-bold text-primary-heading">
                    {achievement.value}
                  </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3  gap-6">
          ...
          <Card className="lg:col-span-2  border-gray-200 bg-transparent cursor-pointer hover:shadow-lg transition-shadow duration-200">
            <CardHeader>
              <CardTitle className="text-primary-heading text-xl md:text-2xl">
                Performance Overview
              </CardTitle>
              <p className="text-xs md:text-sm text-secondary">
                Your bowling performance over the last 6 months
              </p>
            </CardHeader>
            <CardContent>
          ...
          {/* Recent Activity */}
          <Card className="border-gray-200 bg-transparent h-full">
            <CardHeader>
              <CardTitle className="text-primary-heading text-xl md:text-2xl font-semibold md:font-bold ">
                Recent Activity
              </CardTitle>
              <p className="text-xs md:text-sm text-secondary">
            ...
            <CardContent>
              <div className="space-y-2 md:space-y-4 overflow-y-auto h-70 md:h-96 lg:h-96 xl:h-[470px] ">
                {recentActivities.map((activity, index) => (
                  <div
                    key={index}
                    className="flex items-start p-2 md:p-4 border rounded-lg border-gray-200 justify-baseline space-x-3 cursor-pointer hover:shadow-md transition-shadow duration-200"
                  >
        ...
        {/* Game Scores Chart */}
        <Card className="border-gray-200 bg-transparent cursor-pointer hover:shadow-lg transition-shadow duration-200">
          <CardHeader>
            <CardTitle className="text-secondary text-sm md:text-base">
              Your game scores over your last 10 games
            </CardTitle>
          </CardHeader>
          <CardContent>
          ...
          {OverviewActivities.map((activity, index) => (
            ...
            >
              <CardContent className=" text-center">
                ...
                <p className="text-xl md:text-3xl  font-semibold md:font-bold text-primary">
                  {activity.score}
                </p>
              </CardContent>
            </Card>
