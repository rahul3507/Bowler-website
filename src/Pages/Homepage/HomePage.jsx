      ...
      <div className="px-6 pt-2 md:pt-6">
        ...
        <div className="mb-2 md:mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            >
              <Link to="/dashboard/players" state={{ players: proPlayers, title: "Pro Players" }}>See All</Link>
            </Button>
          </div>

          <div className="flex flex-wrap justify-center md:justify-start gap-4">
            {proPlayers.slice(0, 4).map((player, index) => (
              <PlayerCard
                key={index}
                name={player.name}
                image={player.image}
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl md:text-3xl font-bold text-primary">Amateure Players</h2>
            <Button
              asChild
              variant="link"
              className="bg-transparent border-none text-sm text-[#3B82F6] md:text-lg p-0"
            >
              <Link to="/dashboard/players" state={{ players: amateurePlayers, title: "Amateure Players" }}>See All</Link>
            </Button>
          </div>

          <div className="flex flex-wrap justify-center md:justify-start gap-4">
            {amateurePlayers.slice(0, 4).map((player, index) => (
              <PlayerCard
                key={index}
                name={player.name}
                image={player.image}
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl md:text-3xl font-bold text-primary">News Feed</h2>
            <Button
              asChild
              variant="link"
              className="bg-transparent border-none text-sm text-[#3B82F6] md:text-lg p-0"
