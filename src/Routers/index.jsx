...
const SelectYourRole = lazy(() => import('@/Pages/SelectYourRole/SelectYourRole'));
...
const TournamentsList = lazy(() => import('@/Pages/Tournaments/TournamentList'));
...
const BowlingStatistics = lazy(() => import('@/Pages/Profile/BowlingStatistics'));
const Privacy = lazy(() => import('@/Pages/Profile/Privacy'));
const Settings = lazy(() => import('@/Pages/Profile/Settings'));
const Media = lazy(() => import('@/Pages/Profile/Media'));

// Admin pages
const DashboardWrapper = lazy(() => import('@/Admin/AdminDashboard/DashboardWrapper'));
        ...
        <Route element={<PublicRoute/>}>
          <Route element={<AuthLayout />}>
            <Route path="/" element={<BackgroundPage />}>
              ...
              <Route path="selectyourrole" element={
              ...
              <Route path="dashboard" element={
                ...
                <Route path="tournaments" element={
                  ...
                  <Route path='tournament-details' element={
                    <Suspense fallback={<RouteLoader />}>
                      <TournamentDetails/>
                    </Suspense>
                  }/>
                ...
                <Route path='profile' element={
                  ...
                  <Route path='bowlingstatistics' element={
                    <Suspense fallback={<RouteLoader />}>
                      <BowlingStatistics/>
                    </Suspense>
                  }/>
              ...
              <Route path="admin-dashboard" element={
                ...
                <Route path='amateur-player' element={
                  <Suspense fallback={<RouteLoader />}>
                    <AmateurPlayer />
                  </Suspense>
                } />
                ...
                <Route path='bowling-benter' element={
                  <Suspense fallback={<RouteLoader />}>
                    <BowlingCenter />
                  </Suspense>
                } />
